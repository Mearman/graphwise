/**
 * SAGE (Salience-Accumulation Guided Exploration) algorithm.
 *
 * Two-phase exploration algorithm that tracks how often nodes appear
 * in discovered paths and uses this salience to guide exploration.
 *
