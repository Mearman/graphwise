...
/**
 * Run all novel expansion algorithms on a graph with the given seeds and
...
/**
 * Run all baseline expansion algorithms on a graph with the given seeds and
 * return a labelled map of results.
 */
...
describe("expansion: cross-algorithm comparison", () => {
	...
	describe("algorithm stats are well-formed for all algorithms", () => {
		it("every algorithm returns valid stats on the social-hub graph", () => {
			...
			const all = new Map<string, ExpansionResult>([
